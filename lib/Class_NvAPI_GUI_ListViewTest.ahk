...
Gui, Margin, 5, 5
Gui, Add, ListView, xm ym w600 h400, Funktion|Ergebnis
LV_ModifyCol(1, 330)
LV_ModifyCol(2, 220)
...
LV_Add( "", "", "")
LV_Add( "", "EnumNvidiaDisplayHandle()",                                        NVIDIA.EnumNvidiaDisplayHandle() )
LV_Add( "", "", "")
LV_Add( "", "EnumPhysicalGPUs().1",                                             NVIDIA.EnumPhysicalGPUs().1 )
LV_Add( "", "", "")
LV_Add( "", "GetAssociatedDisplayOutputId()",                                   NVIDIA.GetAssociatedDisplayOutputId() )
LV_Add( "", "", "")
...
LV_Add( "", "", "")
LV_Add( "", "GetDVCInfoEx().currentLevel",                                      NVIDIA.GetDVCInfoEx().currentLevel )
LV_Add( "", "GetDVCInfoEx().minLevel",                                          NVIDIA.GetDVCInfoEx().minLevel )
LV_Add( "", "GetDVCInfoEx().maxLevel",                                          NVIDIA.GetDVCInfoEx().maxLevel )
LV_Add( "", "GetDVCInfoEx().defaultLevel",                                      NVIDIA.GetDVCInfoEx().defaultLevel )
LV_Add( "", "", "")
